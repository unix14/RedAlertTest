      ...
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          return ListView.builder(
            itemCount: maximumItems > -1 ? min(maximumItems + 1, alerts.length + 1) : alerts.length + 1,
                ...
                children: [
                  ...
                  Positioned(
                    ...
                    child: IconButton(
                      ...
                      style: ButtonStyle(backgroundColor: MaterialStateProperty.all(Colors.blue),
                          shape: MaterialStateProperty.all(const OvalBorder(eccentricity: 0.9)
                          ),
                      ),
                      onPressed: () {
                  ...
                  Positioned(
                    ...
                    child: IconButton(
                      ...
                      style: ButtonStyle(
                        shape: MaterialStateProperty.all(const OvalBorder(eccentricity: 0.1)),
